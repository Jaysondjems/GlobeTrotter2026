...
async function listUsers(query) {
  ...
  return { data: users.map(toSafeUser), pagination: buildPaginationMeta(page, limit, total) };
}
...
module.exports = { toSafeUser, listUsers, getUserById, createUser, updateUser, deleteUser };
